...
The Helloworld.cfg file is a config file intended to be loaded into the Nanobeacon Config Tool. The Helloworld.cfg is a default configuration with the following changes:
- Complete Local Name: "Hello World"
- Manufacturer Specific Data:
    ID: "0x0505" (default)
    Data: "0x<TEMP 2byte 0 0>"
- Static Random Address: Generated By PC Tool (optional)
